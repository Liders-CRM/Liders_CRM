...
<head><meta charset="utf-8"><title>Liders CRM — Gmail</title>
...
Deno.serve(async (req: Request) => {
  ...
  // Error from Google
  if (error) {
    return html(`<h1>❌ שגיאת Google: ${error}</h1><p>נסה שוב מ-Liders Admin.</p>`, 400);
  }
  ...
  // Step 3 — persist tokens (service_role only table)
  ...
  return html(`
    ...
    <p>המייל <strong>liders.crm@gmail.com</strong> מחובר למערכת Liders CRM.</p>
