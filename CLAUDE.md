...
6. ⚠️ **פער מחירים לתשומת לב**: הדף מציג ₪40/סוכן נוסף גם בצוות (לבקשת המשתמש 3/7),
   אבל `_seat_config` ב-SQL (מיגרציה 050) עדיין גובה ₪30/סוכן בצוות. נדרשת החלטה:
   לעדכן SQL ל-₪40 או להחזיר את הדף ל-₪30.
