...
| דף נחיתה (שיווק/הכרות) | https://liders-crm.com/landing.html |
| פאנל אדמין | https://liders-crm.com/admin.html |

> **בהודעות שיווק/outreach ללקוחות פוטנציאליים — תמיד לשלוח את קישור דף הנחיתה (`landing.html`), לא את הכניסה הישירה למערכת.**
